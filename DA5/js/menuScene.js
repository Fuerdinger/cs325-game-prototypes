...
({
    ...
    onEnter: function()
    {
        ...
        if (goto == "start")
        {
            this.scene.start("levelScene", "level0");
            return;
        }
    ...
    create: function(optionKey)
    {
        ...
        for (var i = 0; i < this.jsonOptions["options"].length; i++)
        {
            this.textoptions.push(this.add.text(0, (i+1) * 70, this.jsonOptions["options"][i]["option"]));
        }
